    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-location" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-comment">Сортировка</label>
            <div class="col-sm-10">
              <input type="text" name="sort_order" value="<?php echo $sort_order; ?>"  id="sort_order" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-comment">Уникальный ИД 1с </label>
            <div class="col-sm-10">
              <input type="text" name="id_erp" value="<?php echo $id_erp; ?>"  id="id_erp" class="form-control" />
            </div>
          </div>
        </form>
      </div>

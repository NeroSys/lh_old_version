          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="category_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control this-input-for-translit" />
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="checkbox"><label><input name="show_preview" type="checkbox" id="checkbox-show_preview" value="1" <?php if ($show_preview) { ?>checked="checked"<?php } ?> /></label></div>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <div class="checkbox"><label><input name="show_in_top" type="checkbox" id="checkbox-show_in_top" value="1" <?php if ($show_in_top) { ?>checked="checked"<?php } ?> /></label></div>
                </div>
                <label class="col-sm-2 control-label" for="checkbox-show_in_top_articles"><?php echo $entry_show_in_top_articles; ?></label>
                <div class="col-sm-4">
                  <div class="checkbox"><label><input name="show_in_top_articles" type="checkbox" id="checkbox-show_in_top_articles" value="1" <?php if ($show_in_top_articles) { ?>checked="checked"<?php } ?> /></label></div>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="checkbox-show_in_sitemap"><?php echo $entry_show_in_sitemap; ?></label>
                <div class="col-sm-4">
                  <div class="checkbox"><label><input name="show_in_sitemap" type="checkbox" id="checkbox-show_in_sitemap" value="1" <?php if ($show_in_sitemap) { ?>checked="checked"<?php } ?> /></label></div>
                </div>
                <label class="col-sm-2 control-label" for="checkbox-show_in_sitemap_articles"><?php echo $entry_show_in_sitemap_articles; ?></label>
                <div class="col-sm-4">
                  <div class="checkbox"><label><input name="show_in_sitemap_articles" type="checkbox" id="checkbox-show_in_sitemap_articles" value="1" <?php if ($show_in_sitemap_articles) { ?>checked="checked"<?php } ?> /></label></div>
                </div>
              </div>
            </div>
            ...
            <div class="tab-pane" id="tab-comments">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="show_comments_vk_id"><?php echo $entry_comments_vk; ?></label>
                <div class="col-sm-3">
                  <div class="checkbox"><label><input name="show_comments_vk_category" type="checkbox" value="1" <?php if ($show_comments_vk_category) { ?>checked="checked"<?php } ?> /> <?php echo $entry_show_comments_category; ?></label></div>
                  <div class="checkbox"><label><input name="show_comments_vk_article" type="checkbox" value="1" <?php if ($show_comments_vk_article) { ?>checked="checked"<?php } ?> /> <?php echo $entry_show_comments_article; ?></label></div>
                </div>
                <div class="col-sm-3">
                  <?php echo $help_comments_id; ?><br /><input type="text" name="show_comments_vk_id" value="<?php echo $show_comments_vk_id; ?>" id="show_comments_vk_id" class="form-control"><br /><?php echo $help_comments_vk; ?>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="show_comments_fb_id"><?php echo $entry_comments_fb; ?></label>
                <div class="col-sm-3">
                  <div class="checkbox"><label><input name="show_comments_fb_category" type="checkbox" value="1" <?php if ($show_comments_fb_category) { ?>checked="checked"<?php } ?> /> <?php echo $entry_show_comments_category; ?></label></div>
                  <div class="checkbox"><label><input name="show_comments_fb_article" type="checkbox" value="1" <?php if ($show_comments_fb_article) { ?>checked="checked"<?php } ?> /> <?php echo $entry_show_comments_article; ?></label></div>
                </div>
                 <div class="col-sm-3">
                  <?php echo $help_comments_fb; ?>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="show_comments_dq_id"><?php echo $entry_comments_dq; ?></label>
                <div class="col-sm-3">
                  <div class="checkbox"><label><input name="show_comments_dq_category" type="checkbox" value="1" <?php if ($show_comments_dq_category) { ?>checked="checked"<?php } ?> /> <?php echo $entry_show_comments_category; ?></label></div>
                  <div class="checkbox"><label><input name="show_comments_dq_article" type="checkbox" value="1" <?php if ($show_comments_dq_article) { ?>checked="checked"<?php } ?> /> <?php echo $entry_show_comments_article; ?></label></div>
                </div>
                <div class="col-sm-3">
                  <?php echo $help_comments_id_dq; ?><br /><input type="text" name="show_comments_dq_id" value="<?php echo $show_comments_dq_id; ?>" id="show_comments_dq_id" class="form-control"><br /><?php echo $help_comments_dq; ?>
                </div>
              </div>
            </div>
          </div>

<ul id="menu">
  <li id="dashboard"><a href="<?php echo $home; ?>"><i class="fa fa-dashboard fa-fw"></i> <span><?php echo $text_dashboard; ?></span></a></li>
    ...
    <li id="newsblog"><a class="parent"><i class="fa fa-newspaper-o fa-fw"></i> <span><?php echo $text_newsblog; ?></span></a>
      <ul>
        <li><a href="<?php echo $newsblog_category; ?>"><?php echo $text_newsblog_category; ?></a></li>
        <li><a href="<?php echo $newsblog_article; ?>"><?php echo $text_newsblog_article; ?></a></li>
      </ul>
    </li>

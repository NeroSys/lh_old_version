      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-group_option" data-toggle="tab">Спецификации</a></li>
            <li><a href="#tab-option" data-toggle="tab">Опции спецификации</a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-group_option"><?php require("product_form/tab-group-options.tpl")?></div>
                        ...
                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                          <thead>
                            <tr>
                              ...
                              <td class="text-right" style="display:none"><?php echo $entry_quantity; ?></td>
                              <td class="text-left" style="display:none"><?php echo $entry_subtract; ?></td>
                              <td class="text-right" style="display:none"><?php echo $entry_price; ?></td>
                              <td class="text-right" style="display:none"><?php echo $entry_option_points; ?></td>
                              <td class="text-right" style="display:none"><?php echo $entry_weight; ?></td>
                              <td class="text-right">Выберите спецификацию</td>
                              <td></td>
                            </tr>
                          </thead>
                          <tbody>
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              ...
                              <td class="text-right" style="display:none"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][quantity]" value="<?php echo $product_option_value['quantity']; ?>" placeholder="<?php echo $entry_quantity; ?>" class="form-control" /></td>
                              <td class="text-left"  style="display:none"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][subtract]" class="form-control">
                              ...
                              <td class="text-right"  style="display:none"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price_prefix]" class="form-control">
                              ...
                              <td class="text-right"  style="display:none"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][points_prefix]" class="form-control">
                              ...
                              <td class="text-right"  style="display:none"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][weight_prefix]" class="form-control">
                              ...
                              <td class="text-right">
                                <select required name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>]['product_option_group']" class="form-control">
                                  <?php foreach($product_option_groups as $option_group){?>
                                  <option <?php if($option_group->id === $product_option_value['product_option_group']) {echo 'selected';} ?>value="<?php echo $option_group->id?>"><?php echo $option_group->id_erp?></option>
                                  <?php }?>
...
function addOptionValue(option_row) {
	...
	html += '  <td style="display:none" class="text-right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][quantity]" value="" placeholder="<?php echo $entry_quantity; ?>" class="form-control" /></td>';
	html += '  <td style="display:none" class="text-left"><select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][subtract]" class="form-control">';
	html += '    <option value="1"><?php echo $text_yes; ?></option>';
	html += '    <option value="0"><?php echo $text_no; ?></option>';
	html += '  </select></td>';
	html += '  <td style="display:none" class="text-right"><select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][price_prefix]" class="form-control">';
	...
	html += '  <td style="display:none"  class="text-right"><select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][points_prefix]" class="form-control">';
	html += '    <option value="+">+</option>';
	html += '    <option value="-">-</option>';
	html += '  </select>';
	...
	html += '  <td style="display:none"  class="text-right"><select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][weight_prefix]" class="form-control">';
	html += '    <option value="+">+</option>';
	html += '    <option value="-">-</option>';
	html += '  </select>';
    ...
    html += '  <td class="text-right"><select name="product_option[\' + option_row + \'][product_option_value][\' + option_value_row + \'][product_option_group]" class="form-control">';
    <?php foreach ($product_option_groups as $option_group) { ?>
        html += '<option value="<?php echo $option_group->id; ?>"><?php echo addslashes($option_group->id_erp); ?></option>';
    <?php } ?>
    html += ' </select></td>';

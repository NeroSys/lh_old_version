    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-novaposhta" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-sort-order">Ключ API</label>
            <div class="col-sm-10">
              <input type="text" name="novaposhta_api_key" value="<?php echo $novaposhta_api_key; ?>" placeholder="API KEY" id="input-sort-order" class="form-control" />
            </div>
          </div>
        </form>
      </div>

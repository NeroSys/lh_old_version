...
namespace App\Overrides\Catalog\Model\Checkout;

use App\Entity\Order;
use App\Entity\OrderProduct;

require_once DIR_OPENCART . 'catalog/model/checkout/order.php';

class OrderModel extends \ModelCheckoutOrder
{
    public function addOrder($data) {
        ...
        if (isset($data['products'])) {
            foreach ($data['products'] as $product) {
                ...
                $order_product->product_id = (int)$product['product_id'];
                $order_product->name = $product['name'];
                $order_product->model = $product['model'];
                $order_product->quantity = (int)$product['quantity'];
                $order_product->price = (float)$product['price'];
                $order_product->total = (float)$product['total'];
                $order_product->tax = (float)$product['tax'];
                $order_product->reward = (int)$product['reward'];
                $order_product->ean = $product['ean'];
                $order_product->save();
